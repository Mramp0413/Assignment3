...
<body>       <!--NAVBAR ADDED -->
  ...
  <h1>Animal Pictures</h1>
        ...
        <ol class="breadcrumb">
  <li>
                    <a href="http://mramp413.com/assign-03/animalPics.php">animal</a>
                </li>
                <li>
      ...
      <section>
          ...
          <ul class="photos gallery-parent">
              <li>
                <a href="images/animalPic1.jpg" data-title="Image one"
