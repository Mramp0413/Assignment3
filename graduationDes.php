  ...
  <div class="modal fade" id="myModal" role="dialog">
            ...
            <nav id="spy">
                <ul class="sidebar-nav nav">
                    <li class="sidebar-brand">
                        <a href="#home"><span class="fa fa-home solo">Wedding </span></a>
                    </li>
                    <li>
                        <a href="#anch1" data-scroll>
                            <span class="fa fa-anchor solo">Baby </span>
                        </a>
                    </li>
                    <li>
                        <a href="#anch2" data-scroll>
                            <span class="fa fa-anchor solo">Concert </span>
                        </a>
                    </li>
                    <li>
                        <a href="#anch3" data-scroll>
                            <span class="fa fa-anchor solo">Animal</span>
                        </a>
                    </li>
                    <li>
                        <a href="#anch4" data-scroll>
                            <span class="fa fa-anchor solo">Graduation </span>
                        </a>
                    </li>
                    
                    <li>
                        <a href="#anch4" data-scroll>
                            <span class="fa fa-anchor solo">Modeling </span>
                        </a>
                    </li>
                </ul>
            </nav>
    ...
    <div class="jumbotron">
        ...
        <div class="container">
             <div class="row">
  <div class="col-md-5">
            <img src="images/graduationDes2.jpg">
                 </div>
      <!-- Example row of columns -->
     
                   <div class="col-md-7">
                      
          <em><h3>Graduations & Senior Pictures</h3></em><br>
